...
object LotteryType {
    ...
    //   选九中九改为浮动（单注最高25万）；选八中六 88→80、选七中七 10000→8500 等多档调整。
    ...
    val KL8 = LotteryTypeConfig(
        ...
        ruleVersions = listOf(
            LotteryTypeConfig.RuleVersion(
                ...
                changeNote = "2025-12-30第2025350期起执行新规则：选十中十、选九中九改为浮动奖金（单注最高" +
                    "分别为500万元、25万元）；选十中八800→720、选九中七200→225、选九中六20→22、" +
                    "选八中六88→80、选七中七10000→8500、选七中六288→300、选七中五28→30、" +
                    "选六中六3000→2880、选五中四21→20、选四中四100→93、选三中三53→52、" +
                    "选一中一4.6→4.5，其余奖级奖金不变。",
            ...
            LotteryTypeConfig.RuleVersion(
                ...
                changeNote = "2020-10-28至2025-12-29（第2025349期）旧规则：选十中十浮动奖金、选十中九8000元、" +
                    "选十中八800元、选十中七80元、选十中六5元、选十中五3元、选十全不中2元；" +
                    "选九中九固定奖金30万元、选九中七200元。",
                realTiersToUse = 7, prizeTierPairCount = 39,  // 查询只走选十7档匹配；解析39对用于展示
                extraFieldCount = 2,  // 销售额 + 奖池
                rules = listOf(
                    // 选十玩法（用户选号默认 mainN=10，仅此玩法参与查询命中判断）
